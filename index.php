...
$sql = "SELECT id, name, price_s, price_m, price_l, image, description, stock FROM products WHERE price_m BETWEEN {$min} AND {$max}";
...
<section class="products product-page">
  <div class="container">
    ...
    <div class="products-header">
        ...
        <p class="products-subtitle">Khám phá hương vị trà sữa tuyệt vời nhất, được pha chế thủ công bằng cả tâm huyết</p>
    </div>
    ...
    <div class="filter-section">
      <form method="GET" class="filter-form">
        ...
        <div style="display: flex; gap: 10px; margin-left: auto; align-items:center;">
            <?php if ($is_filtering): ?>
                <a href="<?= BASE_URL ?><?= $category_id > 0 ? 'pages/category.php?id='.$category_id : 'index.php' ?>" class="btn-clear">
                    Xóa bộ lọc
                </a>
            <?php endif; ?>
    ...
    <div class="product-grid">
      ...
      <?php else: ?>
        <div class="empty-state">
          ...
          <a href="<?= BASE_URL ?>" class="btn-primary-large">Xem lại tất cả</a>
        </div>
      <?php endif; ?>
    </div>
